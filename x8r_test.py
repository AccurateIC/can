    ...
    while True:
        ...
        if len(buffer) >= SBUS_FRAME_SIZE:
            ...
            if buffer[0] == SBUS_INVERTED_HEADER or buffer[0] == SBUS_HEADER:
                ...
                print("Digital Channel 17:", digital_17)
                print("Digital Channel 18:", digital_18)
                print("Frame Lost:", frame_lost)
                print("Failsafe Active:", failsafe_active)
                print("------------------------")
